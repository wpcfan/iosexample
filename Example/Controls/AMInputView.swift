...
@IBDesignable class AMInputView: UIView,UITextFieldDelegate {
    ...
    private func setViewExpandMode(expand:Bool){
        ...
        labelViewRightExpandConstraint.priority = UILayoutPriority(rawValue: expand ? 500:200)
        labelViewLeftExpandConstraint.priority = UILayoutPriority(rawValue: expand ? 500:200)
